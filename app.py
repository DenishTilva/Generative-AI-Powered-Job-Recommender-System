...
if uploaded_file:
    ...
    with st.spinner("Creating Future Roadmap..."):
        roadmap = ask_gemini(f"Based on this resume, suggest a future roadmap to improve this person's career prospects (Skills to learn, certifications needed, industry exposure): \n\n{resume_text}", max_tokens=400)
